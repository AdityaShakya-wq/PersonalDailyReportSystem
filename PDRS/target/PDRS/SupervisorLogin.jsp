	...
	<div class="container">
		<div class="row content">
			<div class="col-md-4 mb-1">
				<img src="images/sup.png" class="img-fluid">
			</div>
			<div class="col-md-6 mb-3">
				<h3 class="signin-text mb-5">Sign In</h3>
				<form class="needs-validation" action="getSControl" method="get" novalidate>
					<div class="form-group">

						<label for="exampleUsername">Username</label> <input type="text"
							class="form-control" id="exampleUsername"
							aria-describedby="UsernameHelp" placeholder="Enter Username"
							required="required" autocomplete="off" name="SNAME"></input>
					...
					<div class="form-group">
						...
						<label for="exampleInputPassword1">Password</label> <input
							...
							placeholder="Password" required name="SPASS">
